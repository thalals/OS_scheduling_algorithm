...
public class GUI_test extends JFrame {
	...
	private Image Background = new ImageIcon(Gui_Main.class.getResource("introBackground.PNG")).getImage();

	private ImageIcon exitButton = new ImageIcon(Gui_Main.class.getResource("ExitButtonBasic.png"));
	private ImageIcon startButtonImage = new ImageIcon(Gui_Main.class.getResource("startButton.png"));
	private ImageIcon menubarimage = new ImageIcon(Gui_Main.class.getResource("menuBar.png"));
